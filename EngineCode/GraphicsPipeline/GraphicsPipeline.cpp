...
void CGraphicsPipeline::CreateGraphicsPipeline(const CreateGraphicsPipelineParams& Params)
{
    ...
    VkShaderModule vertShaderModule = CreateShaderModule(vertShaderCode, Params.m_LogicalDevice);
    VkShaderModule fragShaderModule = CreateShaderModule(fragShaderCode, Params.m_LogicalDevice);
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float)Params.m_SwapChainExtent.width;
    viewport.height = (float)Params.m_SwapChainExtent.height;
    viewport.minDepth = 0.0f;
    viewport.maxDepth = 1.0f;

    VkRect2D scissor = {};
    scissor.offset = { 0, 0 };
    scissor.extent = Params.m_SwapChainExtent;
    ...
    pipelineInfo.renderPass = Params.m_RenderPass;
